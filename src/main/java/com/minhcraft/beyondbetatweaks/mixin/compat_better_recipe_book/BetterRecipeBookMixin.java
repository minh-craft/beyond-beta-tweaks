...
public abstract class BetterRecipeBookMixin {
    ...
    private static BRBBookCategories.Category beyond_beta_tweaks$disableLingeringPotionRecipeBookCategory(BRBHelper.Book instance, ItemStack[] entries, Operation<BRBBookCategories.Category> original) {
