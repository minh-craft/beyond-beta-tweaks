package com.minhcraft.beyondbetatweaks.mixin.compat_better_climbing;
...
public abstract class LivingEntityMixinSquared {
    ...
    private double beyond_beta_tweaks$modifyMaximumDownwardClimbingSpeed(double constant) {
        return -0.3;
    }
    ...
    private double beyond_beta_tweaks$modifyMaximumUpwardClimbingSpeedModifer(double constant) {
        return 1.08;
    }
}
